...
md"""
Here we defined a generic method which works for any variable passed. In the case of `Int64` or `Float64` parameters, special cases are handeld by different methods of the same function. The compiler decides which method to call. This approach allows to specialize implemtations dependent on data types, e.g. in order to optimze perfomance.
...
When trying to force a  variabl to have an abstract type,it
...
md"""
There are operators for testin type relationships
"""
